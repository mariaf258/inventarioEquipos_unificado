...
const obtenerDatos = async () => {
  ...
  const empleadosJuridico: Equipo[] = empleados.filter(empleado => /^MLA-JU-\d+$/
    ...
    <div class="main-content-group">
      <div class="main-content">
        ...
        <div class="container-er">
          <div v-for="(item, index) in empleadosModuloJuridico" :key="index" class="card1" v-bind:item="item as Equipo">
