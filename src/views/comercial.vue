...
const obtenerDatos = async () => {
  ...
  const empleadosComercial: Equipo[] = empleados.filter(empleado => /^MLA-CM-\d+$/
    ...
    <div class="main-content-group">
      <div class="main-content">
        ...
        <div class="container-er">
          <div v-for="(item, index) in empleadosModuloComercial" :key="index" class="card1" v-bind:item="item as Equipo">
